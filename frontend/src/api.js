// Client-Side Curated Knowledge Engine for Tamil Nadu & India (Standalone & Live Hosted Modes)
    ...
    if (!matched) {
      ...
      for (let d = 1; d <= days; d++) {
        dynamicItinerary.push({
          ...
          places: [
            {
              name: d === 1 ? `Historic Center of ${cleanName}` : `Nature & Viewpoint Trail of ${cleanName}`,
              highlight: `Top iconic landmark and scenic highlight in ${cleanName}.`,
              duration: '2.5 hours',
              bestTime: 'Morning (8:30 AM)',
              lat: baseLat + (d * 0.012),
              lng: baseLng + (d * 0.012),
            ...
            {
              name: d === 1 ? `${cleanName} Heritage Fort & Temple` : `Local Bazaar & Food Walk in ${cleanName}`,
              highlight: `Experience authentic local architecture, crafts, and food.`,
              duration: '2-3 hours',
              bestTime: 'Afternoon / Evening',
              lat: baseLat - (d * 0.01),
              lng: baseLng + (d * 0.015),
      ...
      return {
        ...
        lat: baseLat,
        lng: baseLng,
        summary: `A wonderful destination with rich cultural heritage, scenic landmarks, and authentic local experiences.`,
        itinerary: dynamicItinerary,
        hotels: [
          { name: `Grand Heritage Stay ${cleanName}`, type: 'Luxury', price: '₹6,500/night', rating: '4.8★' },
          { name: `The Residency ${cleanName}`, type: 'Mid-range', price: '₹3,200/night', rating: '4.5★' },
          { name: `TripNova Comfort Stay ${cleanName}`, type: 'Budget-friendly', price: '₹1,200/night', rating: '4.3★' },
        ],
